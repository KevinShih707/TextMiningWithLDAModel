...
class TestLda(unittest.TestCase):
    ...
    def setUp(self):
        self.corpora = Corpora(filePath = self.CSV_FILE_PATH)
        # self.corpora.filterFrequentWord()
        self.lda = Lda(self.corpora, numTopics = 2)

    def test_showTopics(self):
        print(self.lda.showTopics())
        exceptResult = [(0, '0.001*"-" + 0.001*"_" + 0.001*" " + 0.001*"」" + 0.001*"、" + 0.001*"與" + 0.001*"圖表" + 0.001*"來" + 0.001*"在" + 0.001*"網址"'),
                        (1, '0.001*"-" + 0.001*" " + 0.001*"圖表" + 0.001*"「" + 0.001*"你" + 0.001*"覺化" + 0.001*"。" + 0.001*"、" + 0.001*"有" + 0.001*","')]
