...
# TODO: 更新註解
class WC():
    def __init__(self, result_topics_list, user_id, topic_id, RUNNING_DEVSERVER=False):
    ...
    def draw_wordcloud(self):
        ...
        # blob = bucket.blob("static/media/wc/" + self.user_id + "/topic-" + str(self.topic_id) + ".png")
        # blob.upload_from_string(data=img_bytes, content_type="image/png")
        #
        # return blob.public_url
        url_list = list()
        for i in range(0,10):
            url_list.append('https://storage.googleapis.com/crawl-curation.appspot.com/static/media/wc/pygtGh4oolanlQBgnYlJHYqUM4D2/topic-' + str(i) + '.png')
